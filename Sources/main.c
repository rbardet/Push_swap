...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/08 04:20:11 by rbardet-          #+#    #+#             */
/*   Updated: 2025/02/03 05:11:38 by rbardet-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (ft_is_sorted(st_a) == 1)
		init_sorting_value(&st_a, &st_b);
	free_stack(&st_a);
	return (0);
}
